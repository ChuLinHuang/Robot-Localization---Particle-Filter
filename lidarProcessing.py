...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        distance_1=np.abs(x_points - y_points) / np.sqrt(2)
        distance_2=np.abs(x_points + y_points) / np.sqrt(2)

        # Getting sensor reading for front_left       
        filter_front_left  = np.logical_and((distance_1 < 0.1),(x_points > 0))
        ...
        # Getting sensor reading for front_right     
        filter_front_right = np.logical_and((distance_2 < 0.1),(x_points > 0))
        ...
        # Getting sensor reading for rear_left       
        filter_rear_left = np.logical_and((distance_2 < 0.1), (y_points > 0))
        ...
        # Getting sensor reading for rear_right       
        filter_rear_right = np.logical_and((distance_1 < 0.1), (y_points < 0))
